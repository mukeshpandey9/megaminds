...
import { FaArrowLeft, FaArrowRight, FaClipboard, FaCode, FaLightbulb, FaBook, FaFileAlt, FaCogs, FaChartLine, FaEdit, FaPen, FaCheckCircle, FaGraduationCap, FaHandshake, FaSmile, FaNewspaper, FaFileSignature, FaProjectDiagram, FaClipboardList, FaChartPie, FaChartBar, FaLaptopCode, FaCloud, FaPython } from 'react-icons/fa';
...
const ResearchPage = () => {
  ...
  <h2 className="text-4xl font-bold mb-6 text-center text-orange-600">SUBJECTS COVERED</h2>
  <div className="flex flex-wrap justify-center gap-6">
    {[
      ...
      <div key={index} className="bg-orange-200 rounded-lg shadow-md overflow-hidden w-72 m-4">
        <div className="w-full h-60 bg-gray-200">
          <img src={imgSrc} alt={alt} className="w-full h-full object-cover" />
        </div>
        <div className="p-4">
          <h3 className="text-2xl font-semibold mb-2 text-orange-700">{title}</h3>
...
<div className="bg-white py-12 w-full text-center">
  <h2 className="text-3xl font-bold mb-6 text-orange-600">Get Your Quote</h2>
  ...
  <form className="max-w-4xl mx-auto bg-orange-50 p-8 rounded-lg shadow-lg">
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      ...
      <div>
        <label htmlFor="contact-number" className="block text-lg font-medium mb-2">Contact Number</label>
        <input 
          type="tel" 
          id="contact-number" 
          name="contact-number" 
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
      <div>
        <label htmlFor="area-of-research" className="block text-lg font-medium mb-4">Area Of Research</label>
        <select 
          id="area-of-research" 
      ...
      <div>
        <label htmlFor="support-type" className="block text-lg font-medium mb-4">Type of Support</label>
        <select 
          id="support-type" 
          name="support-type" 
          className="w-full p-2 border border-gray-300 rounded-lg"
...
<div className="bg-orange-50 py-8 px-4 w-full">
  <h2 className="text-4xl font-bold mb-6 text-center text-orange-600">Thesis Writing Assistance Procedure</h2>
          ...
          >
            <div className="bg-orange-200 p-6 rounded-lg shadow-md">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-2xl font-semibold text-orange-600">{card.title}</h3>
              </div>
